  ...
  return (
    <div className="text-justify text-primary">
      ...
      <p>
        ...
        <Link
          className="hover:underline cursor-pointer font-medium text-brand"
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Audiocalendar.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            Audiocalendar, accessible from{" "}
            <Link
              className="hover:underline cursor-pointer font-medium text-brand"
              href="https://audiocalendar.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://audiocalendar.app/
            </Link>
          </p>
        </li>
        <li>
      ...
      <p>
        We, or authorized third parties, use Cookies and similar tracking
      ...
      <ul>
        <li>
          ...
          We use essential cookies to maintain user login sessions. These
          cookies are necessary for the proper functioning of our web app,
          allowing users to remain logged in while navigating our platform.
          These cookies are strictly necessary, and users cannot opt out of them
          as they are crucial for the basic operation of our services.
        </li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            contact You by email regarding updates or informative communications
      ...
      <p>We may share Your personal information in the following situation:</p>
      <ul>
        <li>
      ...
      <Heading level={3}>Delete Your Personal Data</Heading>
      <p>
      ...
      <ul>
        <li>
          By email:{" "}
          <Link
            href="mailto:szilard@audiocalendar.app"
            className="hover:underline cursor-pointer font-medium text-brand"
            target="_blank"
          >
            szilard@audiocalendar.app
          </Link>
        </li>
      </ul>
    </div>
